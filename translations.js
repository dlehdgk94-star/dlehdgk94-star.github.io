...
const translations = {
  ko: {
    ...
    "local.section.sub": "호텔 근처의 다양한 명소와 편의시설을 확인하세요",
    "local.tab.food": "주변 배달음식, 맛집",
    "local.tab.open24": "24시 편의시설",
    "local.tab.suwon": "수원 둘러보기",
    "local.tab.seoul": "서울 나들이",
    "local.empty": "준비 중입니다",
    // 헤더
    ...
    "intro.welcome_mob": "인스타호텔 본점에 오신 것을 환영합니다.",
    "intro.title": "수원에서 만나는 감각적인 호텔 스테이",
    ...
    "room.detail": "자세히 보기",
    "room.book": "예약하기",
    "room.book_promo": "오늘 특가행사 예약하기",
    "rg.detail_btn": "객실 세부 정보 보기",
    ...
    // 수원 행사일정 (suwon-events.html) — 행사명·설명은 페이지 내 EVENTS 배열에 있음
    "ev.title": "2026 수원 행사 일정",
    "ev.sub": "수원컨벤션센터 · 수원메쎄 · 수원화성에서 열리는 주요 행사와 숙박 정보를 확인하세요.",
    "ev.pill.conv": "수원컨벤션센터",
    "ev.pill.hwaseong": "수원화성",
    "ev.pill.min15": "차량 약 15분",
    "ev.pill.messe": "수원메쎄",
    "ev.pill.parking": "대형주차장 완비",
    "ev.pill.evcharge": "전기차 충전 가능",
    "ev.pill.front": "24시간 프런트",
    "ev.cta.label": "수원의 특별한 순간, 인스타 호텔과 함께",
    "ev.cta.title": "수원 행사 방문을 준비하고 계신가요?",
    "ev.cta.sub": "행사 일정에 맞춰 인스타호텔 본점의 객실을 확인해보세요.",
    "ev.cta.btn": "행사 날짜로 객실 확인하기",
    ...
    "suc.btn.home": "홈으로",
    "suc.err.title": "결제 확인에 실패했습니다",
    "suc.err.sub": "카드사 또는 관리자에게 문의해 주세요.",
    "suc.err.back": "이전으로 돌아가기",
  ...
  en: {
    ...
    "local.section.sub": "Discover attractions and facilities near the hotel",
    "local.tab.food": "Food & Delivery",
    "local.tab.open24": "Open 24h Nearby",
    "local.tab.suwon": "Explore Suwon",
    "local.tab.seoul": "Visit Seoul",
    "local.empty": "Coming soon",
    ...
    "intro.welcome_mob": "Welcome to INSTA Hotel Flagship.",
    ...
    "room.book_promo": "Book Today's Special",
    "rg.detail_btn": "Room Details",
    ...
    // 수원 행사일정 (suwon-events.html) — 행사명·설명은 페이지 내 EVENTS 배열에 있음
    "ev.title": "Suwon Event Calendar 2026",
    "ev.sub": "Events at Suwon Convention Center, Suwon Messe and Hwaseong Fortress — with where to stay.",
    "ev.pill.conv": "Suwon Convention Center",
    "ev.pill.hwaseong": "Hwaseong Fortress",
    "ev.pill.min15": "15 min by car",
    "ev.pill.messe": "Suwon Messe",
    "ev.pill.parking": "Large parking lot",
    "ev.pill.evcharge": "EV charging available",
    "ev.pill.front": "24h front desk",
    "ev.cta.label": "Your Suwon trip, made easy",
    "ev.cta.title": "Coming to Suwon for an event?",
    "ev.cta.sub": "A good night matters. Check room availability for your event dates.",
    "ev.cta.btn": "See rooms for event dates",
    // 모바일 상단 빠른 연결 (index.html #mob-trigger-bar)
    "mob.tel": "Call",
    ...
    "suc.btn.home": "Home",
    "suc.err.title": "Payment could not be confirmed",
    "suc.err.sub": "Please contact your card issuer or the hotel.",
    "suc.err.back": "Go back",
  ...
  ja: {
    ...
    "local.section.sub": "ホテル近くの名所と便利施設をご確認ください",
    "local.tab.food": "Food & Delivery",
    "local.tab.open24": "Open 24h Nearby",
    "local.tab.suwon": "Explore Suwon",
    "local.tab.seoul": "Visit Seoul",
    ...
    "intro.welcome_mob": "INSTAホテル本店へようこそ。",
    ...
    "room.detail": "詳細を見る",
    "room.book": "料金を確認",
    "room.book_promo": "本日の特価で予約",
    "rg.detail_btn": "客室詳細を見る",
    ...
    // 수원 행사일정 (suwon-events.html) — 행사명·설명은 페이지 내 EVENTS 배열에 있음
    "ev.title": "2026 水原イベント日程",
    "ev.sub": "水原コンベンションセンター・水原メッセ・華城の主なイベントと宿泊情報。",
    "ev.pill.conv": "水原コンベンションセンター",
    "ev.pill.hwaseong": "水原華城",
    "ev.pill.min15": "車で約15分",
    "ev.pill.messe": "水原メッセ",
    "ev.pill.parking": "大型駐車場完備",
    "ev.pill.evcharge": "EV充電可能",
    "ev.pill.front": "24時間フロント",
    "ev.cta.label": "水原の特別な時間を、インスタホテルで",
    "ev.cta.title": "水原のイベントにお越しですか？",
    "ev.cta.sub": "快適な休息が旅を変えます。イベント日程に合わせて客室をご確認ください。",
    "ev.cta.btn": "イベント日程で客室を見る",
    // 모바일 상단 빠른 연결 (index.html #mob-trigger-bar)
    "mob.tel": "電話",
    "taxi.kakao": "カカオタクシー",
    "taxi.uber": "Uber",
    ...
    "suc.btn.rooms": "客室を見る",
    "suc.btn.home": "ホームへ",
    "suc.err.title": "決済の確認に失敗しました",
    "suc.err.sub": "カード会社またはホテルまでお問い合わせください。",
    "suc.err.back": "前に戻る",
  ...
  zh: {
    ...
    "local.section.sub": "了解酒店附近的各大景点和便利设施",
    "local.tab.food": "Food & Delivery",
    "local.tab.open24": "Open 24h Nearby",
    "local.tab.suwon": "Explore Suwon",
    "local.tab.seoul": "Visit Seoul",
    ...
    "intro.welcome_mob": "欢迎来到INSTA酒店本店。",
    ...
    "room.detail": "查看详情",
    "room.book": "查看价格",
    "room.book_promo": "今日特价预订",
    "rg.detail_btn": "查看客房详情",
    ...
    // 수원 행사일정 (suwon-events.html) — 행사명·설명은 페이지 내 EVENTS 배열에 있음
    "ev.title": "2026 水原活动日程",
    "ev.sub": "水原会展中心 · 水原会展馆 · 华城主要活动与住宿信息。",
    "ev.pill.conv": "水原会展中心",
    "ev.pill.hwaseong": "水原华城",
    "ev.pill.min15": "车程约15分钟",
    "ev.pill.messe": "水原会展馆",
    "ev.pill.parking": "大型停车场",
    "ev.pill.evcharge": "提供电动车充电",
    "ev.pill.front": "24小时前台",
    "ev.cta.label": "水原的特别时刻，与 INSTA 酒店同行",
    "ev.cta.title": "来水原参加活动吗？",
    "ev.cta.sub": "舒适的休息成就特别的旅行。现在就按活动日期查看客房。",
    "ev.cta.btn": "按活动日期查看客房",
    // 모바일 상단 빠른 연결 (index.html #mob-trigger-bar)
    "mob.tel": "电话",
    "taxi.kakao": "Kakao打车",
    "taxi.uber": "Uber",
    ...
    "suc.btn.rooms": "浏览客房",
    "suc.btn.home": "返回首页",
    "suc.err.title": "支付确认失败",
    "suc.err.sub": "请联系发卡机构或酒店。",
    "suc.err.back": "返回上一页",
