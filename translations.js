...
const translations = {
  ko: {
    ...
    "taxi.kakao": "카카오 택시",
    "taxi.uber": "우버",
    "appmodal.taxi.title": "택시 호출",
    "appmodal.delivery.title": "음식 배달 주문",
    "appmodal.address.label": "호텔 주소",
    "appmodal.taxi.hint": "출발지에 입력하세요",
    "appmodal.delivery.hint": "배달 주소에 입력하세요\n(객실 호수를 함께 적어주세요)",
    "appmodal.copy": "주소 복사",
    "appmodal.copied": "복사됨 ✓",
    "appmodal.open": "앱 열기",
  ...
  en: {
    ...
    "taxi.uber": "Uber",
    "appmodal.taxi.title": "Call a Taxi",
    "appmodal.delivery.title": "Order Food Delivery",
    "appmodal.address.label": "Hotel Address",
    "appmodal.taxi.hint": "Enter as your pickup location",
    "appmodal.delivery.hint": "Enter as delivery address\n(include your room number)",
    "appmodal.copy": "Copy Address",
    "appmodal.copied": "Copied ✓",
    "appmodal.open": "Open App",
  ...
  ja: {
    ...
    "taxi.kakao": "カカオタクシー",
    "taxi.uber": "Uber",
    "appmodal.taxi.title": "タクシーを呼ぶ",
    "appmodal.delivery.title": "フードデリバリー注文",
    "appmodal.address.label": "ホテル住所",
    "appmodal.taxi.hint": "出発地として入力してください",
    "appmodal.delivery.hint": "配達先住所に入力してください\n（お部屋番号も添えてください）",
    "appmodal.copy": "住所をコピー",
    "appmodal.copied": "コピーしました ✓",
    "appmodal.open": "アプリを開く",
  ...
  zh: {
    ...
    "taxi.kakao": "Kakao打车",
    "taxi.uber": "Uber",
    "appmodal.taxi.title": "叫出租车",
    "appmodal.delivery.title": "外卖订餐",
    "appmodal.address.label": "酒店地址",
    "appmodal.taxi.hint": "请填写为出发地",
    "appmodal.delivery.hint": "请填写为配送地址\n（请一并注明房间号）",
    "appmodal.copy": "复制地址",
    "appmodal.copied": "已复制 ✓",
    "appmodal.open": "打开应用",
